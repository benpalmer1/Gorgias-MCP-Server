...
export function registerCustomerTools(server: McpServer, client: GorgiasClient) {
  ...
  server.registerTool("gorgias_get_customer", {
    ...
    inputSchema: {
      id: z.number().int().describe("The ID of the customer to retrieve."),
  ...
  server.registerTool("gorgias_create_customer", {
    ...
    inputSchema: {
      ...
      custom_fields: z.array(z.object({
        id: z.number().int().describe("The ID of the custom field definition to set."),
  ...
  server.registerTool("gorgias_update_customer", {
    ...
    inputSchema: {
      id: z.number().int().describe("The ID of the customer to update."),
  ...
  server.registerTool("gorgias_delete_customer", {
    ...
    inputSchema: {
      id: z.number().int().describe("The ID of the customer to delete."),
    },
  ...
  server.registerTool("gorgias_delete_customers", {
    ...
    inputSchema: {
      ids: z.array(z.number().int()).min(1).describe("A list of customer IDs to delete."),
    },
    annotations: { readOnlyHint: false, destructiveHint: true, idempotentHint: true, openWorldHint: true },
  }, safeHandler(async (args) => {
  ...
  server.registerTool("gorgias_merge_customers", {
    ...
    inputSchema: {
      source_id: z.number().int().min(1).describe("The ID of the customer to merge (the source). This customer will be deleted after the merge."),
      target_id: z.number().int().min(1).describe("The ID of the target customer (which will still exist after the merge)."),
  ...
  server.registerTool("gorgias_set_customer_data", {
    ...
    inputSchema: {
      customer_id: z.number().int().describe("The ID of the customer to update."),
  ...
  server.registerTool("gorgias_list_customer_field_values", {
    ...
    inputSchema: {
      customer_id: z.number().int().describe("The ID of the customer whose custom field values are to be listed."),
    },
    annotations: { readOnlyHint: true, openWorldHint: true },
  ...
  server.registerTool("gorgias_update_customer_field_value", {
    ...
    inputSchema: {
      customer_id: z.number().int().describe("The ID of the customer whose custom field value is to be updated."),
      id: z.number().int().describe("The ID of the custom field to update the value for."),
      definition_id: z.number().int().describe("The custom field DEFINITION ID (from gorgias_list_custom_fields). Sent as 'id' in the request body."),
  ...
  server.registerTool("gorgias_delete_customer_field_value", {
    ...
    inputSchema: {
      customer_id: z.number().int().describe("The ID of the customer whose custom field value is to be deleted."),
      id: z.number().int().describe("The ID of the custom field for which the value should be deleted."),
    },
    annotations: { readOnlyHint: false, destructiveHint: true, idempotentHint: true, openWorldHint: true },
